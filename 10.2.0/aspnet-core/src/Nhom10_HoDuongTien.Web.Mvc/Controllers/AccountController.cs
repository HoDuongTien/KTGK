...
using Nhom10_HoDuongTien.Web.Models.Account;
using Nhom10_HoDuongTien.Web.Views.Shared.Components.TenantChange;
...
public class AccountController : Nhom10_HoDuongTienControllerBase
{
