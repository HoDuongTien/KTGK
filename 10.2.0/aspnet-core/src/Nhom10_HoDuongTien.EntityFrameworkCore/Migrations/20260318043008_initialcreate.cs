...
namespace Nhom10_HoDuongTien.Migrations
{
    /// <inheritdoc />
    public partial class initialcreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PhanThis", x => x.Id);
                    table.ForeignKey(
                        name: "FK_PhanThis_DeThis_DeThiId",
                        column: x => x.DeThiId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    PhanThiId = table.Column<int>(type: "int", nullable: false),
                    NoiDung = table.Column<string>(type: "nvarchar(max)", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_DoanVans", x => x.Id);
                    table.ForeignKey(
                        name: "FK_DoanVans_PhanThis_PhanThiId",
                        column: x => x.PhanThiId,
                        principalTable: "PhanThis",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    PhanThiId = table.Column<int>(type: "int", nullable: false),
                    DoanVanId = table.Column<int>(type: "int", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_CauHois_DoanVans_DoanVanId",
                        column: x => x.DoanVanId,
                        principalTable: "DoanVans",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_CauHois_PhanThis_PhanThiId",
                        column: x => x.PhanThiId,
                        principalTable: "PhanThis",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Nhan = table.Column<string>(type: "nvarchar(1)", maxLength: 1, nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_LuaChons", x => x.Id);
                    table.ForeignKey(
                        name: "FK_LuaChons_CauHois_CauHoiId",
                        column: x => x.CauHoiId,
            ...
            migrationBuilder.CreateTable(
                name: "CauTraLoiNguoiDungs",
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    CauHoiId = table.Column<int>(type: "int", nullable: false),
                    LuaChonId = table.Column<int>(type: "int", nullable: false),
                    UserId = table.Column<long>(type: "bigint", nullable: false),
                    CauHoiId1 = table.Column<int>(type: "int", nullable: true),
                    LuaChonId1 = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_CauTraLoiNguoiDungs", x => x.Id);
                    table.ForeignKey(
                        name: "FK_CauTraLoiNguoiDungs_AbpUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AbpUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_CauTraLoiNguoiDungs_CauHois_CauHoiId",
                        column: x => x.CauHoiId,
                        principalTable: "CauHois",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_CauTraLoiNguoiDungs_CauHois_CauHoiId1",
                        column: x => x.CauHoiId1,
                        principalTable: "CauHois",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_CauTraLoiNguoiDungs_LuaChons_LuaChonId",
                        column: x => x.LuaChonId,
                        principalTable: "LuaChons",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_CauTraLoiNguoiDungs_LuaChons_LuaChonId1",
                        column: x => x.LuaChonId1,
                        principalTable: "LuaChons",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CauHois_DoanVanId",
                table: "CauHois",
                column: "DoanVanId");

            migrationBuilder.CreateIndex(
                name: "IX_CauHois_PhanThiId",
                table: "CauHois",
                column: "PhanThiId");

            migrationBuilder.CreateIndex(
                name: "IX_CauTraLoiNguoiDungs_CauHoiId",
                table: "CauTraLoiNguoiDungs",
                column: "CauHoiId");

            migrationBuilder.CreateIndex(
                name: "IX_CauTraLoiNguoiDungs_CauHoiId1",
                table: "CauTraLoiNguoiDungs",
                column: "CauHoiId1");

            migrationBuilder.CreateIndex(
                name: "IX_CauTraLoiNguoiDungs_LuaChonId",
                table: "CauTraLoiNguoiDungs",
                column: "LuaChonId");

            migrationBuilder.CreateIndex(
                name: "IX_CauTraLoiNguoiDungs_LuaChonId1",
                table: "CauTraLoiNguoiDungs",
                column: "LuaChonId1");

            migrationBuilder.CreateIndex(
                name: "IX_CauTraLoiNguoiDungs_UserId",
                table: "CauTraLoiNguoiDungs",
                column: "UserId");

            migrationBuilder.CreateIndex(
                name: "IX_DoanVans_PhanThiId",
                table: "DoanVans",
                column: "PhanThiId");

            migrationBuilder.CreateIndex(
                name: "IX_LuaChons_CauHoiId",
                table: "LuaChons",
                column: "CauHoiId");

            migrationBuilder.CreateIndex(
                name: "IX_PhanThis_DeThiId",
                table: "PhanThis",
                column: "DeThiId");
        }
