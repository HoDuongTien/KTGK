...
namespace Nhom10_HoDuongTien.EntityFrameworkCore.Seed.Host;
...
public class DefaultLanguagesCreator
{
    ...
    {
        var tenantId = Nhom10_HoDuongTienConsts.MultiTenancyEnabled ? null : (int?)MultiTenancyConsts.DefaultTenantId;
    ...
    public DefaultLanguagesCreator(Nhom10_HoDuongTienDbContext context)
    {
        _context = context;
    }
