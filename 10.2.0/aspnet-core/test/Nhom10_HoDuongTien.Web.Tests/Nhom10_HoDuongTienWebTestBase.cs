...
public abstract class Nhom10_HoDuongTienWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
{
    protected static readonly Lazy<string> ContentRootFolder;

    static Nhom10_HoDuongTienWebTestBase()
    {
    ...
    protected override IWebHostBuilder CreateWebHostBuilder()
    {
        return base
            ...
            .UseSetting(WebHostDefaults.ApplicationKey, typeof(Nhom10_HoDuongTienWebMvcModule).Assembly.FullName);
    }
    ...
    {
        using (var context = IocManager.Resolve<Nhom10_HoDuongTienDbContext>())
        {
            action(context);
            context.SaveChanges();
        }
    ...
    protected async Task UsingDbContextAsync(Func<Nhom10_HoDuongTienDbContext, Task> action)
    {
        using (var context = IocManager.Resolve<Nhom10_HoDuongTienDbContext>())
        {
    ...
    protected async Task<T> UsingDbContextAsync<T>(Func<Nhom10_HoDuongTienDbContext, Task<T>> func)
    {
        T result;
